...
if [ $# -lt 3 ]; then
	echo "Usage: $ <firehose_stream> <product> <component> <units/service to ignore> <time_format>"
	echo "example: $0 log-stream \"product a\" \"component b\" \"redis.service,postgresql\" \"2006-01-02T15:04:05.000Z\" "
...
Environment="TIME_FORMAT=$time_format"
